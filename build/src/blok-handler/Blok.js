 ...
 *
 */
var Blok = /** @class */ (function (_super) {
    __extends(Blok, _super);
    /**
     *
     */
    function Blok(config, dirPath) {
     ...
     *
     */
    Blok.prototype.build = function () {
        return __awaiter(this, void 0, void 0, function () {
            var entryPoint, _a, error, blokInit;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        entryPoint = path_1.join(this.dirPath, this.config.entryPoint);
                        return [4 /*yield*/, patterns_1.safely(Promise.resolve().then(function () { return __importStar(require(entryPoint)); }))];
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 2]), error = _a[0], blokInit = _a[1];
                        if (error) {
     ...
     *
     */
    Blok.prototype.enable = function () {
        this.init();
        this.isEnabled = true;
    };
    /**
     *
     */
    Blok.prototype.disable = function () {
        this.isEnabled = false;
    };
    /**
     *
     */
    Blok.prototype.init = function () {
