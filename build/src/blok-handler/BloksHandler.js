...
var BloksHandler = /** @class */ (function (_super) {
    ...
    function BloksHandler(config) {
        ...
        Promise.all(blokBuildPromises).catch(function (buildError) { return _this.log("One or more of the blok builds failed! There is probably more information above.", buildError); });
        return _this;
    }
    /**
     *
     */
    BloksHandler.prototype.getBloks = function () {
        return this.bloks;
    };
    /**
     *
